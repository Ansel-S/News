...
from db_utils import paper_exists, insert_paper, insert_error
...
def process_paper_entry(entry, *, feed_key: str, source_name: str, r: str) -> None:
    url = entry.get("link", "")
    ...
    if pdf_link:
        ...
        if pdf_data is None:
            insert_error("paper", run_id=r, source_id=url,
    ...
    insert_paper(
        ...
        pdf_data=pdf_data, created_at=created_at,
    )
